	...
	return []ToolDefinition{
		...
		},
		{
			...
			InputSchema: map[string]any{"type": "object", "required": []string{"action"}, "properties": map[string]any{
				"action":          map[string]any{"type": "string", "enum": []string{"on", "off", "stop", "status", "voices", "setup", "set_mode", "set_voice", "engine_status", "setup_engine", "upgrade_engine", "repair_engine", "rollback_engine", "remove_engine"}},
				"mode":            map[string]any{"type": "string", "enum": []string{"brief", "full"}},
				...
				"engine":          map[string]any{"type": "string", "enum": []string{"auto", "system", "say", "sapi", "piper", "kokoro"}},
				"voice":           map[string]any{"type": "string"},
				"fallback_engine": map[string]any{"type": "string", "enum": []string{"auto", "system", "say", "sapi", "piper", "kokoro"}},
				"fallback_voice":  map[string]any{"type": "string"},
				"install_missing": map[string]any{"type": "boolean"},
				"consent":         map[string]any{"type": "boolean"},
				"plan_digest":     map[string]any{"type": "string"},
				"apply":           map[string]any{"type": "boolean"},
				"remove_models":   map[string]any{"type": "boolean"},
			}},
		},
		{
			Name:        "mem_save",
