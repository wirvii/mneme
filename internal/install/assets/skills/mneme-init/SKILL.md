...
| Fusion never concatenates | A foreign agent's body was EXTRACTED and re-drafted into fresh `areas_layer3_md` prose, never pasted verbatim (rule 12) | Re-read the foreign file, pull out only the project-knowledge facts, and write new prose in your own words |
